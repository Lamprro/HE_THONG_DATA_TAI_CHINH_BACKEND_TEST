...
@Component
@ConditionalOnProperty(prefix = "financial.validation.catalog", name = "seed-enabled", havingValue = "true")
public class ValidationRuleCatalogSeeder implements ApplicationRunner {
    private final ValidationRuleCatalogService catalog;
    public ValidationRuleCatalogSeeder(ValidationRuleCatalogService catalog) { this.catalog = catalog; }
