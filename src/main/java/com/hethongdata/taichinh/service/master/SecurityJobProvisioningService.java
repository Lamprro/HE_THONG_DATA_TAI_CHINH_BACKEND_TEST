...
public class SecurityJobProvisioningService {
    ...
    public SecurityJobProvisioningService(
    ...
    private JobDefinition job(
        ...
        options.entrySet().stream()
                .filter(entry -> !"lookbackDays".equals(entry.getKey()))
                ...
                source
                        ...
                        + ("QUOTE".equals(suffix)
                                ...
                                : "OHLCV".equals(suffix)
                                        ...
                                        : "NEWS".equals(suffix)
                                                ? "_30M"
                                                : "EVENTS".equals(suffix)
                                                                || "COMPANY".equals(suffix)
                                                        ? "_DAILY"
                                                        : "_WEEKLY");
        return new JobDefinition(
                code,
                source + " " + security.getSymbol() + " " + suffix.toLowerCase(),
                source,
                dataset,
                cron,
                root);
